// the main observation is, transform the array to
// [i] -> (i, the index of the position which has same color and that is
// kth same color from i towards left).
// Rest is standard problem, given bunch of (x, y) find number of points
// where l <= x <= r and y < l.
// Solved it in O(nlogn) using persistent segment tree.
